import { CSSProperties, FC, ForwardRefExoticComponent, MouseEventHandler, PropsWithChildren } from "react";
...
const Button: FC<PropsWithChildren<Props>> = ({
  ...
  if (linkTo) {
    return (
      <Link href={linkTo} style={style} onClick={onClick} className={classes}>
        {children}
