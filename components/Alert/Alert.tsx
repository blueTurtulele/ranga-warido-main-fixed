...
import { FC, ForwardRefExoticComponent, PropsWithChildren, useEffect, useState } from "react";
...
const Alert: FC<PropsWithChildren<Props>> = ({ children, className, icon: Icon }) => {
